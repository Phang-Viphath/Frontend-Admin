...
const statusBadgeClass = (status) => {
  ...
  if (s.includes('check') && s.includes('in')) return 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400'
  if (s.includes('check') && s.includes('out')) return 'bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400'
